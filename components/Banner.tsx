...
const Banner = () => {
  ...
  return (
    <div className="bg-red-900">
      <div className="mx-auto flex max-w-7xl h-[300px] md:h-[500px] items-center justify-between border-y border-black bg-red-900 pt-28 pb-10 lg:pt-20 lg:pb-0 xl:border-hidden">
